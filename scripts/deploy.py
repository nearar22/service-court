...
def main():
    ...
    for attempt in range(16):
        try:
            ...
            if not transient or attempt == 15: raise
    ...
    out = {"network":"studionet","chainId":61999,"tx":str(tx),"address":str(record.get("recipient")),"explorer":"https://explorer-studio.genlayer.com"}
